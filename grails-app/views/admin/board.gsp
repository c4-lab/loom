                                    ...
                                    <g:each in="${experiments}" var="experiment">
                                        <div class="post row">
                                            ...
                                            <div class="user-block clo-xs-2">
                                                <g:link controller="admin" action="launchExperiment" params="[experimentId: experiment.id]">
                                                    <button type="button" class="btn btn-primary">Launch Session</button>
                                                </g:link>
                                            </div>
                                    ...
                                    <g:each in="${stories}" var="story">
                                        <div class="post">
                                            <div class="user-block">
                                                ...
                                                <span class='description'>
                                                <g:each in="${story.tails}" var="tails">
                                                    ${tails.text}
                                                </g:each>
                                                </span>
            ...
            <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name='min_nodes' id='min_nodes' min="2" max="100" value="2" style="color:black;">
                        <p></p>
                        <label>Maximum allowed nodes: </label>
                        <input type="number" name='max_nodes' id='max_nodes' min="2" max="100" value="2" style="color:black;">

                        <p></p>
                        <label  >Initial number of tiles: </label>
                        <input type="number" name='initialNbrOfTiles' id='initialNbrOfTiles' min="2" max="100" value="2" style="color:black;">
                        <p></p>
                        <label  >Number of rounds: </label>
                        <input type="number" name='rounds' id='rounds' min="1" max="100" value="2" style="color:black;">
                        <p></p>
                        <label >Round duration: </label>
                        <input type="number" name='duration' id='duration' min="1" max="100" value="2" style="color:black;"><label > seconds </label>
...
%{--                        <input type="text" style="color:black;" name="qualifier">--}%
                    ...
                    <div id="qualify" style="display:none">
                        ...
                        <select  style="display:none" >
                            <option><input type="number"  name='performance' id='performance' min="0" max="5" value="0" style="color:black;" required=False></option>
                        </select>

                        <label >Reading performance >=</label>
                        <select  style="display:none" >
                            <option><input type="number"  name='reading' id='reading' min="0" max="5" value="0" style="color:black;" required=False></option>
                        </select>
                    ...
                    <div>
                        ...
                        <label><input type="radio" onclick="chooseType('Lattice')" name="network_type" value="Lattice" />1D Lattice</label>
                        <label><input type="radio" onclick="chooseType('Newman-Watts')" name="network_type" value="Newman_Watts"/>Newman-Watts</label>
                        <label><input type="radio" onclick="chooseType('Barabassi-Albert')" name="network_type" value="Barabassi_Albert"/>Barabassi-Albert</label>
                    </div>
                    ...
                    <div id="s1" style="display:none">
                        ...
                        <select  style="display:none" >
                            ...
                            <option><input type="number"  name='min_degree' id='Lattice_min_degree' min="2" max="100" value="0" style="color:black;" required=False></option>
                        </select>
                    </div>
                    <div id="s2" style="display:none">

                        <label>degree: </label>
                            <input type="number" min="3" max="100" name='min_degree' value="3" id='Newman_min_degree' style="color:black;">
                        <p></p>
                        <label>k-nearest neighbors: </label>
                        <input type="number" min="3" max="100"  name='max_degree' value="3" id='Newman_max_degree' style="color:black;">
                        <p></p>
                        <label>shortcut probability: </label>
                        <input type="number" step="0.1" name='prob' id='Newman_prob' oninput="if(value>1)value=1;if(value.length>4)value=value.slice(0,4);if(value<=0)value=0.1" style="color:black;"/>


                    </div>
                    <div id="s3" style="display:none">
                        <label>initial nodes: </label>
                        <input type="number" min="2" max="100"  name='min_degree' value="2" id='BA_min_degree' style="color:black;">
                        <p></p>
                        <label>max degree: </label>
                        <input type="number" min="2" max="100"  name='max_degree' value="2" id='BA_max_degree' style="color:black;">
                        <p></p>
